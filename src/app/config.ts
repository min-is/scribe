...
export const APP_CONFIGURATION = {
  ...
  hasCloudflareR2Storage: false,
  hasAwsS3Storage: false,
  hasMultipleStorageProviders: false,
  ...
  aiTextAutoGeneratedFields: [] as string[],
  hasAiTextAutoGeneratedFields: false,
  // Performance
  isStaticallyOptimized: HAS_STATIC_OPTIMIZATION,
  arePhotosStaticallyOptimized: false,
  arePhotoOGImagesStaticallyOptimized: false,
  arePhotoCategoriesStaticallyOptimized: false,
  arePhotoCategoryOgImagesStaticallyOptimized: false,
  ...
  // Display
  categoryVisibility: CATEGORY_VISIBILITY ? CATEGORY_VISIBILITY.split(',') : [],
  hasCategoryVisibility: Boolean(CATEGORY_VISIBILITY),
  collapseSidebarCategories: false,
  showKeyboardShortcutTooltips: SHOW_KEYBOARD_SHORTCUT_TOOLTIPS,
  showExifInfo: false,
  showZoomControls: SHOW_ZOOM_CONTROLS,
  showTakenAtTimeHidden: false,
  showSocial: SHOW_SOCIAL,
  showRepoLink: SHOW_REPO_LINK,
  // Grid
  isGridHomepageEnabled: GRID_HOMEPAGE_ENABLED,
  gridAspectRatio: undefined,
  hasGridAspectRatio: false,
  hasHighGridDensity: HIGH_DENSITY_GRID,
  hasGridDensityPreference: false,
  // Settings
  isGeoPrivacyEnabled: false,
  arePublicDownloadsEnabled: false,
  isPublicApiEnabled: PUBLIC_API_ENABLED,
  isPriorityOrderEnabled: false,
  isOgTextBottomAligned: false,
  // Internal
  ...
  isAdminDbOptimizeEnabled: false,
  // Misc
  baseUrl: BASE_URL,
